...
## The figure (`web/public/models/villager.glb`)

**Authored here, not sourced.** CC0 by construction, ~15 KB, 204 triangles, and
generated by `scripts/build-figure.mjs` — run it after editing that file.
